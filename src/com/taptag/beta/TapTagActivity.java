...
public class TapTagActivity extends Activity {
    ...
    protected void onNewIntent(Intent intent) {
    	...
    	if (writeMode && NfcAdapter.ACTION_TAG_DISCOVERED.equals(intent.getAction())) {
            ...
            boolean writeResult = NFCActions.writeTag(detectedTag, "My App", toWrite);
            if (writeResult) {
    ...
    private void initListView() {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, android.R.id.text1, sampleValues);
    ...
    private void enableExchangeMode() {
        ...
        adapter.enableForegroundDispatch(this, nfcIntent, ndefExchangeFilters, null);
    }
