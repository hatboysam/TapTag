...
import com.taptag.beta.location.Locator;
...
public class VendorListActivity extends Activity {
	...
	private Double[] getLocation() {
		Double[] result = locator.getLatLong();
	...
	public void showLoadingDialog() {
		if (loading == null) {
			loading = ProgressDialog.show(VendorListActivity.this, "TapTag",  "Loading Places...", true);
	...
	public void configureByIntent(Intent intent) {
		...
		if (NEAR_ME.equals(action)) {
			...
			adapter = new ProximityVendorAdapter(VendorListActivity.this ,R.layout.vendorlistitem, R.id.vendorListItemName, allData, getLocation(), 10.0);
		} else {
	...
	public void configureAutoComplete() {		
		...
		autoCompleteAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_dropdown_item_1line, adapter.getNames());
	...
	/**
	 * Asynchronously populate the ListView.  All beahvior in onPostExecute because doInBackground
