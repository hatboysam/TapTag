...
public class Locator {
	...
	public Double[] getLatLong() {
		if (recentLocation != null) {
			...
			return new Double[] { recentLocation.getLatitude(),
	...
	public void startLocating() {
		...
		locationManager.requestLocationUpdates(
				LocationManager.NETWORK_PROVIDER, 1000, 100, locationListener);
	}
	...
	/**
	 * Get the last known location from any provider (most accurate first), in
	 * case there has not been a location reported to this service yet
	 * 
	 * @return
	 */
